...
cp "$node_source/workflows/trellis2_mlx_sparse_structure.json" \
    "$workflow_dir/CFP_TRELLIS2_MLX_Sparse_Structure_v001.json"
cp "$node_source/workflows/trellis2_mlx_single_image_manufacturing.json" \
    "$workflow_dir/CFP_TRELLIS2_MLX_Single_Image_Manufacturing_v001.json"
